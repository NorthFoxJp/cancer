---
title: "頸部郭清術・両口蓋扁桃摘出術と入院"
description: "右頸部郭清術、両口蓋扁桃摘出術、喉頭の検査を同時に受けた患者本人による、手術当日、術後の痛み、入院、退院までの体験記です。"
permalink: /surgery/neck-dissection-and-tonsillectomy/
stage: 手術・入院
event_period: 2022年2月17日〜退院まで
lead: 右頸部郭清術、両口蓋扁桃摘出術などを同時に受けたときの、入院から退院までの記録です。
breadcrumb_parent_title: 手術
...
related_links:
  - title: 手術後の回復と残った症状
    url: /surgery/recovery-and-aftereffects/
...
<figure>
  <img src="{{ '/assets/images/surgery/hospital-room.jpg' | relative_url }}" alt="入院した病室の窓から見た風景" loading="lazy">
  <figcaption>病室からの眺め</figcaption>
</figure>

<figure>
  <img src="{{ '/assets/images/surgery/last-dinner-before-treatment.jpg' | relative_url }}" alt="手術前日の病院の夕食" loading="lazy">
  <figcaption>完全に味が分かる状態での最後の夕食</figcaption>
</figure>
...
目が覚めたとたん、呼吸ができない感じで非常に苦しいし（SpO2は正常な範囲）、頭は経験したことのない強烈な痛みだし、先生に「根治の可能性が高い事はすべてやります！化学療法もやります！」なんて言わなければよかった！と、全力で思いました。以下、その時に思ってたこと……「泣き言」と言います。
...
<div class="image-pair">
  <figure>
    <img src="{{ '/assets/images/surgery/meal-soft-rice.jpg' | relative_url }}" alt="入院中のお粥の朝食" loading="lazy">
    <figcaption>23日の朝食、お粥</figcaption>
  </figure>
  <figure>
    <img src="{{ '/assets/images/surgery/meal-regular.jpg' | relative_url }}" alt="入院中の一般食の朝食" loading="lazy">
    <figcaption>24日の一般食</figcaption>
  </figure>
</div>
